        ...
        <div className="vta-hero-content">
         ...
         VISHAL TRADING ACADEMY
          ...
          <div className="vta-hero-buttons">
            <a href="https://wa.me/9828259167" target="_blank" rel="noopener noreferrer" className="vta-btn-primary">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <a href="https://wa.me/9828259167" target="_blank" rel="noopener noreferrer" className="vta-btn-secondary">
